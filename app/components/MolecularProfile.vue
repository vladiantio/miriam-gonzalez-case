    ...
    ? [
        {
          ...
          note: 'Driver principal; resistencia a CDK4/6i, sensibilidad a everolimus',
          highlight: true,
        },
        {
          marker: 'CCND1',
        ...
        },
        {
          marker: 'Ki67',
          result: '60%',
          note: 'Alto índice proliferativo en mama. En tumores neuroendocrinos, Ki67 ≥20% define el grado de agresividad: un 60% sitúa este tumor en grado 3 (NEC) ⁺⁺',
          highlight: false,
        },
        {
          marker: 'TMB / MSI',
        ...
        },
        {
          ...
          note: 'Sin fusiones detectadas',
          highlight: false,
        },
        {
          marker: 'PIK3CA / ESR1',
          result: 'No detectados en tejido',
          note: 'Pendiente análisis complementario',
          highlight: false,
        },
        {
          marker: 'HER2',
    ...
    : [
        {
          marker: 'FGFR1',
          result: 'Amplified ×13',
          note: 'Main driver; CDK4/6i resistance, everolimus sensitivity',
          highlight: true,
        },
        {
          marker: 'CCND1',
        ...
        },
        {
          marker: 'Ki67',
          result: '60%',
          note: 'High proliferative index in breast cancer. In neuroendocrine tumours, Ki67 ≥20% defines aggressiveness grade: 60% places this tumour at grade 3 (NEC) ⁺⁺',
          highlight: false,
        },
        {
          marker: 'TMB / MSI',
        ...
        },
        {
          ...
          note: 'No fusions detected',
          highlight: false,
        },
        {
          marker: 'PIK3CA / ESR1',
          result: 'Not detected in tissue',
          note: 'Pending complementary analysis',
          highlight: false,
        },
        {
          marker: 'HER2',
