...
const integrativeSupport = computed(() =>
  locale.value === 'es'
    ? [
        ...
        { role: 'Doctor en Ciencias del Deporte y oncología del ejercicio (España)', description: 'Investigador principal en oncología del ejercicio en la Fundación OncSport. Diseña y supervisa el programa de entrenamiento individualizado de Míriam.', icon: 'ph:barbell-fill', color: 'ocean' as const },
    ...
    : [
        ...
        { role: 'Doctor of Sport Sciences & Exercise Oncology (Spain)', description: 'Principal investigator in exercise oncology at Fundación OncSport. Designs and supervises Miriam\'s individualised training programme.', icon: 'ph:barbell-fill', color: 'ocean' as const },
        ...
        { role: 'Psychology & High Capacity', description: 'Psychologist specialised in high intellectual capacity. Supports Miriam by integrating cognitive dimensions with the oncological process.', icon: 'ph:brain-fill', color: 'ocean' as const },
